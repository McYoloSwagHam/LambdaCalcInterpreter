...
/**
 * This is the main class, where program execution starts. it gets an input from
 * the user and then passes it to LexicalParser it then reduces until the hash
 * is equivalent to the last TODO: make an ArrayList of hashes, and check since
 * recursive processes might have multiple steps instead of being 1 step
 * reductions.
 *
...
public class main {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      currentHash = ASTNode.HashAST(lexer.rootNode);
      ...
      while (true) {
        ...
        // then we know that it's recursive since the has will always result in this
        // hash again
