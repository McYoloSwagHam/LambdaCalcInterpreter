...
public class LexicalParser
{
     ...
     */
        ...
        public void Tokenize(String lambdaExpression) throws Exception {
            ...
            //   I could make the switch case a lambda, capture all the variables in my current function
                ...
                switch (currentLetter) {
                    ...
                    case '(': // 
                        ...
                        if (!IsSpecialCharacter(lastCharacter)) {
                            throw new LexerError("Syntax Error : '(' preceded by invalid character, " +
                    ...
                    case '\\':
                        ...
                        if (ExprRefCount == 0) {
                            //TODO: Err Invalid ExpressiON
                            throw new LexerError("Definition Error: lambda definitions are only valid " +
                                    "in open expressions " + counter);
                        }
                    ...
                    case '.':
                        ...
                        if (IsSpecialCharacter(lastCharacter)) {
                            throw new LexerError("Syntax Error: . preceded by invalid character, " +
                                    "should be preceded by letter (Definition)");
                        }
                    ...
                    default: //Not a special character, used for names
                        ...
                        if (!isLocalDefinitionAllowed && ExprRefCount == 0) {
                            throw new LexerError("Definition Error: invalid function call or local definition" +
                                    " , open the expression");
                        }
